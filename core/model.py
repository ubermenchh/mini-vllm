...
class ModelExecutor:
    ...
    def _paged_attention_forward(self, module, hidden_states: torch.Tensor, *args, **kwargs):
        ...
        # Q: [batch_size, 1, num_heads * head_dim] -> [batch_size, num_heads, head_dim]
        # K: [batch_size, num_kv_heads * head_dim] -> [batch_size, num_kv_heads, head_dim]
        ...
        if executor.is_prefill:
            ...
            # k_cache: [blocks, num_kv_heads, block_size, head_dim]
